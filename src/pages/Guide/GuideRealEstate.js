...
class GuideRealEstateScreen extends Component {
...
const GuideRealEstate = createMaterialTopTabNavigator({
    GuideRealEstateScreen: GuideRealEstateScreen,
    FindHouse: FindHouse,
    SellHouse: SellHouse, 
}, {
    tabBarOptions: {
...
export default GuideRealEstate;